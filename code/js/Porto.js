...
let margin_price = {top:50,left:150}
let margin_review={top:10,left:150}
...
function draw_lisbon(lisbon_map){
    ...
    let x_scale_legend = [0,20,40,60,80,100,120,140,160]
    ...
    x_scale_legend = [0,20,40,60,80,100,120,140,160]
...
function draw_graph(type,data_lisbon,grouped_graph){
    ...
    grouped_graph.append("g")
        ...
        if (type =="price"){
            grouped_graph.append("text")
                ...
                .attr("x",-graph_height/2-margin.top*3)
                .text("Mean Price")
            ...
            grouped_graph.append("g")
                .attr("transform","translate(100,68)")
                .selectAll("text")
                .data(subgroups)
                .enter()
                .append("text")
            ...
            grouped_graph.selectAll("text")
                .data(subgroups)
                .enter()
                .append("text")
                    .attr("x", svg_grouped_price_w-margin.left+30)
                    .attr("y", function(d,i){return 25 + i*15})
                    .style("fill","black")
                    .text(function(d){ 
                        console.log("legenda ",d)
            ...
            .attr("transform", "rotate(-90)")
            .attr("y",margin.left - 40)
            .attr("x",-graph_height/2-margin.top*4)
            .text("Mean Review")
    ...
    graph.append("g")
        ...
        .attr("fill", function(d) {
            console.log("key",d.key,"color",colorGraph(d.key))
